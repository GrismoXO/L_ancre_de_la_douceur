...
<body class="">
    ...
    <header class=" h-screen" >
        ...
        <div class="w-full flex justify-center">
            <div class="flex  w-3/5 bg-white/50 rounded-lg">
    ...
    <div class="bg_pink_opa flex flex_col_800 ">
    ...
    <div class="flex items-center justify-center w-full h-full py-24 sm:py-8 px-4 bg-white">
